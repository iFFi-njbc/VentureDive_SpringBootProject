...
/*	@PutMapping("/employees/{id}")
	...
	public EmployeeDTO updateEmployee(@PathVariable Long id, @Valid @RequestBody EmployeeDTO dto)
	{
		...
		d = restTemplate.postForObject("http://localhost:9002/RESTapi/v1/departments/" + emp.getDepartment().getId() , d, Department.class);
		...
		b = restTemplate.postForObject("http://localhost:9003/RESTapi/v1/benifits/" + emp.getBenifits().getId() , b, Benifits.class);
	...
	public ResponseEntity<EmployeeDTO> saveEmployee(@Valid @RequestBody EmployeeDTO empreq)
	{
		...
		//Department d = new Department();
		//Employee m = new Employee();
		d = restTemplate.getForObject("http://localhost:9002/RESTapi/v1/departments/" + empreq.getDepartment(), Department.class);
		...
		b = restTemplate.getForObject("http://localhost:9003/RESTapi/v1/benifits/" + empreq.getBenifits(), Benifits.class);
